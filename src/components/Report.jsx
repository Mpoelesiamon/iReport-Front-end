    ...
    <div>
      ...
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-2 gap-8 mt-5">
        <div className="w-full shadow-xl flex flex-col p-4 my-4 hover:scale-105 duration-300 rounded-[50px]">
          ...
          <button
            className="bg-[#2195f1] w-[200px] rounded-md font-medium my-6 mx-auto py-3 z-30 text-white relative after:-z-20 after:absolute after:h-1 after:w-1 after:bg-[#f7bf0c] after:left-5 overflow-hidden after:bottom-0 after:translate-y-full after:rounded-md after:hover:scale-[300] after:hover:transition-all 
